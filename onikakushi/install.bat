...
echo.
timeout /t 1 > nul
.\aria2c.exe --file-allocation=none --continue=true https://github.com/07th-mod/onikakushi/releases/download/v3.0.1/Onikakushi.Voice.and.Graphics.Patch.v3.0.1.zip
timeout /t 1 > nul
...
echo A | .\7za.exe x Onikakushi.Voice.and.Graphics.Patch.v3.0.1.zip
rmdir /S /Q ..\CG > nul
rmdir /S /Q ..\CGAlt > nul
timeout /t 1 > nul
