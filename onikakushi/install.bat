...
echo.
timeout /t 1 > nul
.\aria2c.exe --file-allocation=none --continue=true https://github.com/07th-mod/onikakushi/releases/download/v2.5/Onikakushi.Voice.and.Graphics.Patch.v2.5.zip
timeout /t 1 > nul
