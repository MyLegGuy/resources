...
echo.
timeout /t 1 > nul
.\aria2c.exe --file-allocation=none --continue=true https://github.com/07th-mod/himatsubushi/releases/download/v2.0.0/Himatsubushi.Voice.and.Graphics.Patch.v2.0.0.zip
timeout /t 1 > nul
