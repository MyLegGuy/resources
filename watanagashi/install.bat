...
echo.
timeout /t 1 > nul
.\aria2c.exe --file-allocation=none --continue=true https://github.com/07th-mod/watanagashi/releases/download/v3.0.0/Watanagashi.Voice.and.Graphics.Patch.v3.0.0.zip
